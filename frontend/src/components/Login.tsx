  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 to-purple-100">
      <div className="bg-white shadow-xl rounded-2xl p-10 w-full max-w-md relative">
        {/* Decorative Circles */}
        <div className="absolute -top-16 -right-16 w-40 h-40 bg-purple-300 rounded-full blur-3xl opacity-50"></div>
        <div className="absolute -bottom-16 -left-16 w-40 h-40 bg-purple-200 rounded-full blur-3xl opacity-40"></div>
